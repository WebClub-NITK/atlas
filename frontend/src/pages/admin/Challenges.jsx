        ...
        <table className="min-w-full bg-[#FFF7ED] rounded-lg overflow-hidden">
          <thead>
            <tr className="bg-[#FFF7ED]">
              ...
              <th className="px-4 py-2 text-left text-gray-900">Difficulty</th>
            ...
            {filteredChallenges.map((challenge) => (
              <tr key={challenge.id} className="border-t border-gray-200">
                ...
                <td className="px-4 py-2 text-gray-900">
                  <Link to={`/admin/challenges/${challenge.id}`} className="text-blue-500 hover:underline">
                    {challenge.title}
                  </Link>
                </td>
                <td className="px-4 py-2 text-gray-900">{difficultyOptions[challenge.difficulty][1]}</td>
